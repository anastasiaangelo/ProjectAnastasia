...
# %%
index = ansatz_isa.layout.final_index_layout()
virtual = ansatz_isa.layout.final_virtual_layout()

measured_bitstring = result2.best_measurement['bitstring']
original_bitstring = ['']*num_qubits

# Reorder the bitstring
for logical in index:
    for physical in virtual:
        original_bitstring[logical] = measured_bitstring[physical]
